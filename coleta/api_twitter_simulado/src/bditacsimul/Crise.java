...
@NamedQueries({
    ...
    @NamedQuery(name = "Crise.findByCidId", query = "SELECT c FROM Crise c WHERE c.cidId = :cidId"),
    @NamedQuery(name = "Crise.findByCriGeotipo", query = "SELECT c FROM Crise c WHERE c.criGeotipo = :criGeotipo")})
public class Crise implements Serializable {
    ...
    public Crise(Integer criId, int crtId, String criDescricao, int cidId, Character criGeotipo) {
        this.criId = criId;
        this.crtId = crtId;
    ...
    public String toString() {
        return "bditacsimul.Crise[ criId=" + criId + " ]";
    }
