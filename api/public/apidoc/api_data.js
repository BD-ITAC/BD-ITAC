define({ "api": [
  {
    "type": "get",
    "url": "/rest/alerts?latitude=-9.44340653710605&longitude=-70.4864968937616&raio=10&timestamp=2016-06-14%2000:11:05",
    "title": "Listar todos alertas confirmados por região",
    "group": "Alertas",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "raio",
            "description": "Raio de alcance em Kms."
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "timestamp",
            "description": "Data e Hora inicial para consulta. Informe '' caso deseje todos. Para filtrar, use o formato yyyy-mm-ddThh:MM:ss"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "datahora",
            "description": "Data e hora da confirmação do alerta."
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "cidade",
            "description": "Nome da cidade do alerta."
          },
          {
            "group": "Success 200",
            "type": "Numero",
          ...
          },
          {
            ...
            "optional": false,
            "field": "tipodacrise",
            "description": "O tipo da crise que originou o alerta."
          }
        ]
      },
      "examples": [
    ...
    "filename": "C:/git/BD-ITAC/api/server/routes/alerts.js",
    "groupTitle": "Alertas",
    "name": "GetRestAlertsLatitude944340653710605Longitude704864968937616Raio10Timestamp2016061420001105"
  },
  {
    "type": "get",
    "url": "/rest/avisos",
    "title": "Listar todos os avisos cadastrados.",
    "version": "1.0.0",
    "group": "Avisos",
    "success": {
      "fields": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "Identificador para especificar consulta de um único aviso."
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/rest/avisos/nearbyWarnings?latitude=-23.196641&longitude=-45.946840&raio=10&timestamp='2016/06/10T08:00:00'",
