module.exports = function(app){
  var uri = '/rest/avisos';
  var controller = app.controllers.avisos;
  /**
   * @api {post} /rest/avisos Cadastrar
   * @apiGroup Avisos
   * @apiVersion 1.0.0
   *
   * @apiParam {String} descricao  Descricao do aviso.
   * @apiParam {Numero{1-8}} categoria  Categoria do aviso.
   ...
   * @apiParam {String} [fotografia]  Uma fotografia do aviso.
   *
   ...
   *
   *
   * @apiSuccess {Numero} id Numero identificador do aviso cadastrada
  ...
  /**
   * @api {get} /rest/avisos/nearbycrisis?latitude=-23.196641&longitude=-45.946840&raio=10 Pesquisa por coordenadas
   * @apiVersion 1.0.0
   * @apiGroup Avisos
   *
