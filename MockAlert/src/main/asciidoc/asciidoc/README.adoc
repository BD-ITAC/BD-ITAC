...
include::{snippets}/crise/locations/http-request.adoc[]

==== Resposta

A resposta irá conter os dados formatados em +JSON+ além do cabeçalho com o resultado da operação:
include::{snippets}/crise/locations/http-response.adoc[]

==== Descrição da resposta

O(s) atributo(s) da resposta são:
include::{snippets}/crise/locations/path-parameters.adoc[]
...
include::{snippets}/crise/get/curl-request.adoc[]

==== Requisição

A requisição toma a seguinte forma:
include::{snippets}/crise/get/http-request.adoc[]

==== Resposta

A resposta irá conter os dados formatados em +JSON+ além do cabeçalho com o resultado da operação:
include::{snippets}/crise/get/http-response.adoc[]
...
include::{snippets}/crise/get/links.adoc[]

==== Descrição da resposta

A descrição do(s) atributo(s) retornado(s):
include::{snippets}/crise/get/response-fields.adoc[]
